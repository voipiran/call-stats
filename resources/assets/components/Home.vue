  ...
  <div id="home">
    ...
    <div class="row my-2 app">
      ...
      <div class="col-12 col-sm-6">
        <div class="select-box p3 my-2">
          <!-- title -->
          <div class="d-flex">
            <div class="guide" v-if="$t('HOME.queueGuide')">
              <p>{{ $t('HOME.queueGuide') }}</p>
            </div>
            <h5 class="m-0">{{ $t('HOME.queueTitle') }}</h5>
          </div>
          <hr />
          <!-- content -->
      ...
      <div class="col-12 col-sm-6">
        <div class="select-box p3 my-2">
          <!-- title -->
          <div class="d-flex">
            <div class="guide" v-if="$t('HOME.agentGuide')">
              <p>{{ $t('HOME.agentGuide') }}</p>
            </div>
            <h5 class="m-0">{{ $t('HOME.agentTitle') }}</h5>
          </div>
          <hr />
          <!-- content -->
          <div class="d-block d-sm-flex justify-content-center w-100">
        ...
        <div class="col-12 d-block d-md-flex justify-content-around">
          ...
          <div class="date-picker row">
            ...
            <div class="col-12 col-md-6 date-holder">
              <div class="mb-2">{{ $t('HOME.fromFilter') }}</div>
            ...
            <!-- toFilter -->
            <div class="col-12 col-md-6 date-holder">
              <div class="mb-2">{{ $t('HOME.toFilter') }}</div>
              <date-picker
                class="mt-2"
                v-model="toFilter"
                :locale="getLocale"
          ...
          <div class="date-picker row">
            <!-- from date -->
            <div class="col-12 col-md-6 date-holder">
              <div class="mb-2">{{ $t('HOME.fromTime') }}</div>

              <date-picker v-model="fromTime" type="time" />
            </div>

            <!-- toFilter -->
            <div class="col-12 col-md-6 date-holder">
              <div class="mb-2">{{ $t('HOME.toTime') }}</div>
              <date-picker v-model="toTime" type="time" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="submit mx-3">
      <button class="btn-submit" @click="submit()">
        <span v-if="!isLoading"> {{ $t('HOME.btnSubmit') }}</span>
        <!-- loader -->
