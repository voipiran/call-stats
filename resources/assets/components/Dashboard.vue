...
.orange-mode {
  ...
  .vue3-slider .track {
    background-color: rgb(241, 148, 131) !important;
  }
...
.blue-mode {
  ...
  color: black !important;
  .table-shadow {
    box-shadow: 3px 12px 13px #4e6378;
  }
  .app {
    ul {
