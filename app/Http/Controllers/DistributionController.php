...
class DistributionController extends Controller
{
	...
	public function getDetail($request)
	{
		try {
			...
			$Unanswered = $this->CalculationDetail($request,  ['RINGCANCELED', 'EXITWITHTIMEOUT', 'EXITWITHKEY']);
	...
	public function getWaitByDate($request)
	{
		try {
			...
			$Unanswered = $this->CalculationWaitByDate($request, ['RINGCANCELED', 'EXITWITHTIMEOUT', 'EXITWITHKEY'], 'Unanswered');
	...
	public function getWaitByTime($request)
	{
		try {
			...
			$Unanswered = $this->CalculationWaitByTime($request, ['RINGCANCELED', 'EXITWITHTIMEOUT', 'EXITWITHKEY'], 'Unanswered');
	...
	public function getAnsweredInWeek($request)
	{
		try {
			...
			$Unanswered = $this->CalculationAnsweredInWeek($request, ['RINGCANCELED', 'EXITWITHTIMEOUT', 'EXITWITHKEY'], 'Unanswered');
	...
	public function getAnsweredInMonth($request)
	{
		try {
			...
			$Unanswered = $this->CalculationAnsweredInMonth($request, ['RINGCANCELED', 'EXITWITHTIMEOUT', 'EXITWITHKEY'], 'Unanswered');
